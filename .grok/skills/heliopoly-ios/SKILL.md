...
- After overlay/Swift changes: device already deleted or **Product → Clean Build Folder**, then **⌘R**. Gold bar must match `ContentView.swift` (currently `HELIOPOLY PHONE · THUMBS · 3`). If the bar does not match, Xcode did not build this tree.
